...
t=timeit.Timer("l.geraListaIdades1(5000,18,65)", "from __main__ import ListaIdades; l=ListaIdades()")
...
if __name__ == "__main__":
    main()
    #import timeit
    #import classListaIdades as lista
    #print(timeit.timeit("lista.geraListaIdades1(5000,18,65)", setup="from __main__ import lista"))
    '''
'''
#myListaIdades = ListaIdades()
#timeit.Timer(ListaIdades.geraListaIdades1(5000,18,65)).timeit()
'''    